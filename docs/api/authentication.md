...
Type. Declared in [`src/AgentForwarding.ts`](../../src/AgentForwarding.ts).
...
Function. Declared in [`src/GSSAPI.ts`](../../src/GSSAPI.ts).
...
Constant. Declared in [`src/GSSAPI.ts`](../../src/GSSAPI.ts).
...
Interface. Declared in [`src/GSSAPI.ts`](../../src/GSSAPI.ts).
...
Class. Declared in [`src/GSSAPI.ts`](../../src/GSSAPI.ts).
