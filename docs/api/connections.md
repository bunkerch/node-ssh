...
Class. Declared in [`src/Client.ts`](../../src/Client.ts).
...
Type. Declared in [`src/Client.ts`](../../src/Client.ts).
...
Interface. Declared in [`src/Client.ts`](../../src/Client.ts).
...
Class. Declared in [`src/HTTPAgents.ts`](../../src/HTTPAgents.ts).
...
Class. Declared in [`src/Server.ts`](../../src/Server.ts).
...
Interface. Declared in [`src/Server.ts`](../../src/Server.ts).
...
Class. Declared in [`src/ServerClient.ts`](../../src/ServerClient.ts).
...
Interface. Declared in [`src/ServerClient.ts`](../../src/ServerClient.ts).
...
Type. Declared in [`src/Server.ts`](../../src/Server.ts).
...
Interface. Declared in [`src/HTTPAgents.ts`](../../src/HTTPAgents.ts).
...
Type. Declared in [`src/HTTPAgents.ts`](../../src/HTTPAgents.ts).
