---
title: Transport and protocol types
description: Exact declarations for 40 package-root exports.
---
...
Constant. Declared in [`src/GlobalRequests.ts`](https://github.com/bunkerch/node-ssh/blob/master/src/GlobalRequests.ts).
