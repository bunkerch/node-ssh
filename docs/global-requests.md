...
request is a protocol error and closes the connection. Request and successful-response packet
boundaries copy their opaque bytes, so caller buffers and received transport frames cannot mutate
